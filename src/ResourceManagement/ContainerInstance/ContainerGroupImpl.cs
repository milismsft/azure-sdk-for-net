...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LmNvbnRhaW5lcmluc3RhbmNlLmltcGxlbWVudGF0aW9uLkNvbnRhaW5lckdyb3VwSW1wbA==
        ...
        IDefinition
    {
        ...
        IReadOnlyCollection<string> IContainerGroup.ImageRegistryServers => new ReadOnlyCollection<string>(imageRegistryServers);

        IReadOnlyCollection<Port> IContainerGroup.ExternalPorts => new ReadOnlyCollection<Port>(
            this.Inner.IpAddress != null && this.Inner.IpAddress.Ports != null ? this.Inner.IpAddress.Ports : new List<Port>());

        IReadOnlyDictionary<string, Volume> IContainerGroup.Volumes => new ReadOnlyDictionary<string, Models.Volume>(volumes);

        string IContainerGroup.IPAddress => this.Inner.IpAddress != null ? this.Inner.IpAddress.Ip : null;

        int[] IContainerGroup.ExternalUdpPorts => this.externalUdpPorts;

        string IContainerGroup.ProvisioningState => this.Inner.ProvisioningState;

        int[] IContainerGroup.ExternalTcpPorts => this.externalTcpPorts;

        bool IContainerGroup.isAlwaysRestart => this.Inner.RestartPolicy.Equals("Always");

        bool IContainerGroup.IsIPAddressPublic => this.Inner.IpAddress != null && IpAddress.Type.Equals("Public");

        IReadOnlyDictionary<string, Container> IContainerGroup.Containers => new ReadOnlyDictionary<string, Container>(this.containers);

        string IContainerGroup.State => this.Inner.State;

        OSTypeName IContainerGroup.OSType => Fluent.OSTypeName.Parse(this.Inner.OsType);
        ...
        IWithPublicOrPrivateImageRegistry IWithOsType.WithLinux()
        {
        ...
        IWithPublicOrPrivateImageRegistry IWithOsType.WithWindows()
        {
        ...
        IWithPrivateImageRegistryOrVolume IWithPrivateImageRegistry.WithPrivateImageRegistry(string server, string username, string password)
        {
        ...
        IWithPrivateImageRegistryOrVolume IWithPublicImageRegistryOnly.WithPublicImageRegistryOnly()
        {
        ...
        IWithFirstContainerInstance IWithPrivateImageRegistryOrVolume.WithoutVolume()
        {
        ...
        IWithFirstContainerInstance IWithPrivateImageRegistryOrVolume.WithNewAzureFileShareVolume(string volumeName, string shareName)
        {
        ...
        IVolumeDefinitionBlank<IWithVolume> IWithPrivateImageRegistryOrVolume.DefineVolume(string name)
        {
            return new VolumeImpl(this, name);
        }

        IVolumeDefinitionBlank<IWithVolume> IWithVolume.DefineVolume(string name)
        {
            return new VolumeImpl(this, name);
        }

        IContainerInstanceDefinitionBlank<IWithNextContainerInstance> IWithFirstContainerInstance.DefineContainerInstance(string name)
        {
            return new ContainerImpl(this, name);
        }

        IWithCreate IWithFirstContainerInstance.WithContainerInstance(string imageName)
        {
        ...
        IWithCreate IWithFirstContainerInstance.WithContainerInstance(string imageName, int port)
        {
            return this.DefineContainerInstance(this.Name)
                .WithImage(imageName)
        ...
        IContainerInstanceDefinitionBlank<IWithNextContainerInstance> IWithNextContainerInstance.DefineContainerInstance(string name)
        {
            return new ContainerImpl(this, name);
        }
